...
try:
    ...
    image = ImageTk.PhotoImage(
        Image.open("C:/Users/yasharth dubey/Documents/Python Scripts/COVID19 management/images.png"))
    ...
    def graphs():
        ...
        def deathc():
            ...
            var1 = IntVar()
            var2 = IntVar()
            tkinter.Checkbutton(window, text="BAR GRAPH", variable=var1, border="0", bg="skyblue2", onvalue=1,
								offvalue=0).place(x=20, y=148)
            tkinter.Checkbutton(window, text="LINE GRAPH", variable=var2, border="0", bg="skyblue2", onvalue=1,
                                offvalue=0).place(x=150, y=148)
            tkinter.Label(window, text="*WE RECOMMEND YOU TO SEE BAR GRAPH FOR ONE COUNTRY", bg="skyblue2",
                          border="0").place(x=20, y=180)
            ...
            def showwwac():
                ...
                tkinter.Label(window2, text="TYPE THE COUNTRIES NAME WITH A COMMA IN END", bg="skyblue2",
							  border="0").pack()
        ...
        def refresh():
            ...
            workbook = xlsxwriter.Workbook(
                "C:/Users/yasharth dubey/Documents/Python Scripts/COVID19 management/Recovered.xlsx")
            workbook.close()
		...
		def coc():
            ...
            var2 = IntVar()
            var3 = IntVar()
            tkinter.Checkbutton(window, text="BAR GRAPH", variable=var2, border="0", bg="skyblue2", onvalue=1,
                                offvalue=0).place(x=20, y=148)
            tkinter.Checkbutton(window, text="LINE GRAPH", variable=var3, border="0", bg="skyblue2", onvalue=1,
								offvalue=0).place(x=150, y=148)
            tkinter.Label(window, text="NUMBER OF COUNTRIES:", bg="skyblue2", border="0").place(x=20, y=120)
    ...
    def tabular():
            ...
            def showt():
                ...
                for i in range(0, sheet.nrows):
                    if (str(sheet.cell_value(i, 0)).upper() == g):
                        ...
                        if (b / int(sheet.cell_value(i, 1)) * 100 >= 2):
                            tkinter.Label(scrollable_frame, text="YOUR COUNTRY IS NOT SUITABLE FOR PROJECT", border="0",
                                          bg="red", font="ARIALBLACK").grid(row=0, column=0, pady=10, ipadx=20)
                            tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 0), border="0", bg="red").grid(
                                row=r, column=0, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 1)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=1,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1), border="0", bg="red").grid(
                                    row=r, column=1, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 2)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=2,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 2), border="0", bg="red").grid(
                                    row=r, column=2, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 3)):
                                tkinter.Label(scrollable_frame, text=0, border="0", bg="red").grid(row=r, column=3,
                                                                                                   pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 3), border="0", bg="red").grid(
                                    row=r, column=3, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 4)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=4,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 4), border="0", bg="red").grid(
                                    row=r, column=4, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 5)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=5,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 5), border="0", bg="red").grid(
                                    row=r, column=5, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 6)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=6,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 6), border="0", bg="red").grid(
                                    row=r, column=6, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 7)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=7,
                                                                                                     pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 7), border="0", bg="red").grid(
                                    row=r, column=7, pady=00, ipadx=20)
                        ...
                        if (int(sheet.cell_value(i, 3)) / int(sheet.cell_value(i, 1)) * 100 < 2) and (
                                int(sheet.cell_value(i, 3)) / int(sheet.cell_value(i, 1)) * 100 >= 1.5):
                            tkinter.Label(scrollable_frame, text="YOUR COUNTRY IS SOMEWHAT SUITABLE FOR PROJECT",
                                          border="0", bg="gold", font="ARIALBLACK").grid(row=0, column=0, pady=10,
                                                                                         ipadx=20)
                            tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 0), border="0", bg="gold").grid(
                                row=r, column=0, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 1)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=1,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1), border="0",
                                              bg="gold").grid(row=r, column=1, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 2)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=2,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 2), border="0",
                                              bg="gold").grid(row=r, column=2, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 3)):
                                tkinter.Label(scrollable_frame, text=0, border="0", bg="gold").grid(row=r, column=3,
                                                                                                    pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 3), border="0",
                                              bg="gold").grid(row=r, column=3, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 4)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=4,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 4), border="0",
                                              bg="gold").grid(row=r, column=4, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 5)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=5,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 5), border="0",
                                              bg="gold").grid(row=r, column=5, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 6)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=6,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 6), border="0",
                                              bg="gold").grid(row=r, column=6, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 7)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=7,
                                                                                                      pady=00, ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 7), border="0",
                                              bg="gold").grid(row=r, column=7, pady=00, ipadx=20)
                        ...
                        if (int(sheet.cell_value(i, 3)) / int(sheet.cell_value(i, 1)) * 100 < 1.5):
                            tkinter.Label(scrollable_frame, text="YOUR COUNTRY IS SUITABLE FOR PROJECT", border="0",
                                          bg="green", font="ARIALBLACK").grid(row=0, column=0, pady=10, ipadx=20)
                            tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 0), border="0", bg="green").grid(
                                row=r, column=0, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 1)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=1,
																									   pady=00,
																									   ipadx=20)
							else:
								tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1), border="0",
											  bg="green").grid(row=r, column=1, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 2)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=2,
																									   pady=00,
																									   ipadx=20)
							else:
								tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 2), border="0",
                                              bg="green").grid(row=r, column=2, pady=00, ipadx=20)
							if (not sheet.cell_value(i, 3)):
								tkinter.Label(scrollable_frame, text=0, border="0", bg="green").grid(row=r, column=3,
																									 pady=00, ipadx=20)
							else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 3), border="0",
											  bg="green").grid(row=r, column=3, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 4)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=4,
																									   pady=00,
																									   ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 4), border="0",
                                              bg="green").grid(row=r, column=4, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 5)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=5,
                                                                                                       pady=00,
                                                                                                       ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 5), border="0",
                                              bg="green").grid(row=r, column=5, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 6)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=6,
                                                                                                       pady=00,
                                                                                                       ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 6), border="0",
                                              bg="green").grid(row=r, column=6, pady=00, ipadx=20)
                            if (not sheet.cell_value(i, 7)):
                                tkinter.Label(scrollable_frame, text="0", border="0", bg="green").grid(row=r, column=7,
                                                                                                       pady=00,
                                                                                                       ipadx=20)
                            else:
                                tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 7), border="0",
                                              bg="green").grid(row=r, column=7, pady=00, ipadx=20)
                r = 3
                for i in range(8, sheet.nrows - 8):
                    if not (sheet.cell_value(i, 0).upper() == h):
                        ...
                        if (b / int(sheet.cell_value(i, 1)) * 100 >= 2):
                            tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 0), border="0", bg="red").grid(
                                row=r, column=0, pady=5, ipadx=20)
                            if (not sheet.cell_value(i, 1)):
								tkinter.Label(scrollable_frame, text="0", border="0", bg="red").grid(row=r, column=1,
																									 pady=00, ipadx=20)
							else:
                ...
                for i in range(8, sheet.nrows - 8):
                    ...
                    if not (sheet.cell_value(i, 0).upper() == g):
						if ((b / int(sheet.cell_value(i, 1)) * 100 < 2) and (
								b / int(sheet.cell_value(i, 1)) * 100 >= 1.5)):
							tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 0), border="0", bg="gold").grid(
                                row=r, column=0, pady=5, ipadx=20)
							if (not sheet.cell_value(i, 1)):
								tkinter.Label(scrollable_frame, text="0", border="0", bg="gold").grid(row=r, column=1,
        ...
        def wwac():
            ...
            def showwwac():
                ...
                body.pack(fill=tkinter.BOTH, expand=True)
                scrollable_frame = Scrollable(body, width=32)
                tkinter.Label(scrollable_frame, text=h, bg="yellow1", border="0", font="ARIAL").grid(row=0, column=5,
                                                                                                     pady=5, padx=10)
                tkinter.Label(scrollable_frame, text="WEEK NUMBER", bg="yellow1", border="0").grid(row=1, column=0,
                                                                                                   pady=5, padx=10)
                tkinter.Label(scrollable_frame, text="AVERAGE CONFIRMED CASE PER WEEK", bg="yellow1", border="0").grid(
                    row=1, column=3, pady=5, padx=10)
                y = 2
                for i in range(0, sheet.nrows):
                    # checking whether the given country is there or not
                    if (sheet.cell_value(i, 2).upper() == h):
                        tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1).upper(), bg="yellow1").grid(row=y,
                                                                                                                column=5,
                                                                                                                pady=5,
                                                                                                                padx=10)
                        y = y + 1
                        ...
                        for k in range(0, no_of_weeks):
                            week = "WEEK " + str(o) + " :"
                            o = o + 1
                            tkinter.Label(scrollable_frame, text=week, bg="yellow2", border="0").grid(row=y, column=0,
                                                                                                      pady=5, padx=10)
                            tkinter.Label(scrollable_frame, text=a[k], bg="yellow2", border="0").grid(row=y, column=3,
                                                                                                      pady=5, padx=10)
                            y = y + 1
                scrollable_frame.update()
                window2.mainloop()
        ...
        def wwad():
            ...
            def showwwac():
                ...
                body.pack(fill=tkinter.BOTH, expand=True)
                scrollable_frame = Scrollable(body, width=32)
                tkinter.Label(scrollable_frame, text=h, bg="red", border="0", font="ARIAL").grid(row=0, column=5,
                                                                                                 pady=5, padx=10)
                tkinter.Label(scrollable_frame, text="WEEK NUMBER", bg="red", border="0").grid(row=1, column=0, pady=5,
                                                                                               padx=10)
                tkinter.Label(scrollable_frame, text="AVERAGE DEATH CASE PER WEEK", bg="red", border="0").grid(row=1,
                                                                                                               column=3,
                                                                                                               pady=5,
                                                                                                               padx=10)
                y = 2
                for i in range(0, sheet.nrows):
                    ...
                    if (sheet.cell_value(i, 2).upper() == h):
                        tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1).upper(), bg="red").grid(row=y,
                                                                                                            column=5,
                                                                                                            pady=5,
                                                                                                            padx=10)
                        y = y + 1
                        ...
                        for k in range(0, no_of_weeks):
                            week = "WEEK " + str(o) + " :"
                            o = o + 1
                            tkinter.Label(scrollable_frame, text=week, bg="red", border="0").grid(row=y, column=0,
                                                                                                  pady=5, padx=10)
                            tkinter.Label(scrollable_frame, text=a[k], bg="red", border="0").grid(row=y, column=3,
                                                                                                  pady=5, padx=10)
                            y = y + 1
                scrollable_frame.update()
                window2.mainloop()
        ...
        def wwar():
            ...
            def showwwac():
                ...
                body.pack(fill=tkinter.BOTH, expand=True)
                scrollable_frame = Scrollable(body, width=32)
                tkinter.Label(scrollable_frame, text=h, bg="limegreen", border="0", font="ARIAL").grid(row=0, column=5,
                                                                                                       pady=5, padx=10)
                tkinter.Label(scrollable_frame, text="WEEK NUMBER", bg="limegreen", border="0").grid(row=1, column=0,
                                                                                                     pady=5, padx=10)
                tkinter.Label(scrollable_frame, text="AVERAGE RECOVERED CASE PER WEEK", bg="limegreen",
                              border="0").grid(row=1, column=3, pady=5, padx=10)
                y = 2
                for i in range(0, sheet.nrows):
                    # here we are checking the cell_value of the column number 3 as it is the country name
                    if (sheet.cell_value(i, 2).upper() == h):
                        tkinter.Label(scrollable_frame, text=sheet.cell_value(i, 1).upper(), bg="limegreen").grid(row=y,
                                                                                                                  column=5,
                                                                                                                  pady=5,
                                                                                                                  padx=10)
                        y = y + 1
                        ...
                        for k in range(0, no_of_weeks):
                            week = "WEEK " + str(o) + " :"
                            o = o + 1
                            tkinter.Label(scrollable_frame, text=week, bg="limegreen", border="0").grid(row=y, column=0,
                                                                                                        pady=5, padx=10)
                            tkinter.Label(scrollable_frame, text=a[k], bg="limegreen", border="0").grid(row=y, column=3,
                                                                                                        pady=5, padx=10)
                            y = y + 1
                scrollable_frame.update()
                window2.mainloop()
        ...
        def county():
            ...
            if count < 2:
                ...
                image = tkinter.PhotoImage(
                    file="C:\\Users\\yasharth dubey\\Documents\\Python Scripts\\COVID19 management\\0.png")
            ...
            # if the symptom count is above 2 and below 4 the risk of COVID-19 is medium and he may consider a doctor
                ...
                image = tkinter.PhotoImage(
                    file="C:\\Users\\yasharth dubey\\Documents\\Python Scripts\\COVID19 management\\1.png")
                tkinter.Label(window3, image=image).pack()
            ...
            # in any other condition the risk is high
                ...
                image = tkinter.PhotoImage(
                    file="C:\\Users\\yasharth dubey\\Documents\\Python Scripts\\COVID19 management\\2.png")
                tkinter.Label(window3, image=image).pack()
...
# finally block
    ...
    tkinter.messagebox.showinfo(title="COVID-19 TRACKER",
                                message="THANKS FOR USING OUR GUI \n SEND US FEEDBACK to yashdubeywinner@gmail.com")